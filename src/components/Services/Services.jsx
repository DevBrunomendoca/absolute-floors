    ...
    <ContainerServices id="container-service" rel={el}>
      ...
      <ContainerEpoxy id="container-epoxy">
        ...
        <div>
          ...
          <ContentParagraph>
            Epoxy flooring is a type of flooring system that involves the use of
            epoxy resins to create a durable, seamless, and chemically resistant
            surface. It has gained popularity in various industrial, commercial,
            and residential settings due to its exceptional performance and
            aesthetic appeal.
          </ContentParagraph>
        </div>
      </ContainerEpoxy>
